...
D2 = so.strip().split("\n")[0].rstrip("/") if so.strip() else D
print("容器: %s\n" % D2)
LOG2 = D2 + "/Documents/ksdid_log.txt"

print("=" * 70); print("1. 安装 v5"); print("=" * 70)
...
print(); print("=" * 70); print("2. 杀快手"); print("=" * 70)
so, se = sush("""
...
print()
print("=" * 70)
print("请打开快手，然后告诉我，我读 IDFV/IDFA")
print("=" * 70)
