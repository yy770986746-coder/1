...
OP = {0x0e:"return-void",0x0f:"return",0x11:"return-object",0x0a:"move-result",
      ...
      0x44:"aget",0x45:"aget-wide",0x46:"aget-object",0x4b:"aput",0x4c:"aput-wide",
...
# 找所有可疑的小类
WANT = ("Lte", "Lue", "Lre", "Lse", "Lve", "Lwe", "Lxe", "Lye", "Lze",
        "Lqf", "Lrg", "Lue", "Lx4", "Lqe")
...
for i in range(fds):
    ...
    if short in WANT:
        found.append((short, cn, v[2], cdoff))

print("=" * 78)
print("★ 找到的类")
print("=" * 78)
for short, cn, sup, cdoff in found:
    print("  %s  extends %s  classdata=%s" % (short, gett(sup) if isinstance(sup,int) else sup,
                                               "有" if cdoff else "无"))
